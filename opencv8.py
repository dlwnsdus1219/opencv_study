...
res1 = cv2.resize(src, dsize=(640, 480), interpolation=cv2.INTER_AREA)   # 영역 보간법
res2 = cv2.resize(src, dsize=(0, 0), fx=0.3, fy=0.7, interpolation=cv2.INTER_LINEAR)    #쌍 선형 보간법
